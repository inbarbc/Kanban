...
namespace BackendTests
{
    internal class UserTests
    {
        ...
        public void RunTestsLogin()
        {
            ...
            //attempt to login guy@gmail.com user with the correct password - should succeed
            //assuming that user with this email and password exist in the kanban
        ...
        public void RunTestsInProgressTasks()
        {
            ...
            string res8 = user.InProgressTasks("guy@gmail.com");
        ...
        public void RunTestsGetUserBoards()
        {
            ...
            string res11 = user.GetUserBoards("guy@gmail.com");
