...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public string LimitColumn(string email, string boardName, int columnOrdinal, int limit)
        {
            try
            {
                return columnS.LimitColumn(email, boardName, columnOrdinal, limit);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string GetColumnLimit(string email, string boardName, int columnOrdinal)
        {
            try
            {
                return columnS.GetColumnLimit(email, boardName, columnOrdinal);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string GetColumnName(string email, string boardName, int columnOrdinal)
        {
            try
            {
                return columnS.GetColumnName(email, boardName, columnOrdinal);
            }
            catch (Exception e)
            {
                return e.Message;
        ...
        public string AddTask(string email, string boardName, string title, string description, DateTime dueDate)
        {
            try
            {
                return taskS.AddTask(email, boardName, title, description, dueDate);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string UpdateTaskDueDate(string email, string boardName, int columnOrdinal, int taskId, DateTime dueDate)
        {
            try
            {
                return taskS.UpdateTaskDueDate(email, dueDate, boardName, columnOrdinal, taskId);
        ...
        public string UpdateTaskTitle(string email, string boardName, int columnOrdinal, int taskId, string title)
        {
            try
            {
                return taskS.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string UpdateTaskDescription(string email, string boardName, int columnOrdinal, int taskId, string description)
        {
            try
            {
                return taskS.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string AdvanceTask(string email, string boardName, int columnOrdinal, int taskId)
        {
            ...
            try
            {
                j = taskS.AdvanceTask(email, boardName, columnOrdinal, taskId);
        ...
        public string GetColumn(string email, string boardName, int columnOrdinal)
        {
            try
            {
                return columnS.getColumn(email, boardName, columnOrdinal);
            }
            catch (Exception ex)
            {
                return ex.Message;
        ...
        public string GetBoardName(int boardId)
        {
            try
            {
                return bc.GetBoardName(boardId);
            }
            catch (Exception e)
            {
                return e.Message;
        ...
        public string JoinBoard(string email, int boardID)
        {
            ...
            try
            {
                j = boardS.JoinBoard(email, boardID);
                var res = JsonSerializer.Deserialize<Response>(j);
                if (res.ErrorMessage == null)
                    return "{}";
                else
        ...
        public string LeaveBoard(string email, int boardID)
        {
            ...
            try
            {
                j = boardS.LeaveBoard(email, boardID);
                var res = JsonSerializer.Deserialize<Response>(j);
                if (res.ErrorMessage == null)
                    return "{}";
                else
        ...
        public string AssignTask(string email, string boardName, int columnOrdinal, int taskID, string emailAssignee)
        {
            ...
            try
            {
                j = taskS.AssignTask(email, boardName, columnOrdinal, taskID, emailAssignee);
                var res = JsonSerializer.Deserialize<Response>(j);
                if (res.ErrorMessage == null)
                    return "{}";
                else
        ...
        public string TransferOwnership(string currentOwnerEmail, string newOwnerEmail, string boardName)
        {
            ...
            try
            {
                j = ???.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
                var res = JsonSerializer.Deserialize<Response>(j);
                if (res.ErrorMessage == null)
                    return "{}";
                else
